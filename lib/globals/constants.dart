...
BorderRadius kBorderRadiusInput = const BorderRadius.all(Radius.circular(20.0));
EdgeInsets kInputPaddingHorizontal = const EdgeInsets.symmetric(horizontal: 8.00,vertical: 4);
...
EdgeInsets allPadding = const EdgeInsets.only(left: 20.00, right:20.00,bottom: 32);
